...
class UpdateClubRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'short_name' => 'required|string|max:5|unique:clubs,short_name,' . $this->route('club')->id,
    ...
    public function messages(): array
    {
        return [
            ...
            'name.unique' => 'This club name is already taken by another club.',
            'short_name.required' => 'Short name is required.',
            'short_name.max' => 'Short name cannot be longer than 5 characters.',
            'short_name.unique' => 'This short name is already taken by another club.',
